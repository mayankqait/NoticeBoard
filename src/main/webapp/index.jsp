...
<body>
 ...
 <center>
    <div id="noticeboard">
      <h1>NOTICE BOARD</h1>  
    </div>                                               <!--      To get response in json -->
  </center>                                              <!-- http://localhost:8086/NoticeBoard/webapi/myresource/readJson -->                          
    <form method="get" action="http://localhost:8086/NoticeBoard/webapi/myresource/readUI"> 
 <center> 
